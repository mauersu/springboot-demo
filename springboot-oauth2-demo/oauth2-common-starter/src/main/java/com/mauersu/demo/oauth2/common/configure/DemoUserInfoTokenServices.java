 ...
 */
public class DemoUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public DemoUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
